...
public class program {
    public static void main(String[] args) {
        ...
        laptops.add(new Laptop("Xiaomi", 16, 512, "Linux", "Silver"));
        laptops.add(new Laptop("Apple", 8, 256, "MacOS", "Silver"));
        laptops.add(new Laptop("MSI", 32, 512, "Linux", "Black"));
        laptops.add(new Laptop("Lenovo", 32, 1024, "Windows", "Gray"));
        laptops.add(new Laptop("MSI", 32, 512, "Windows", "Black"));
        ...
        while (true) {
            ...
            switch (choice) {
                case 1:
                    ...
                    break;
                case 2:
                    System.out.println("Минимальный объем ЖД1?");
